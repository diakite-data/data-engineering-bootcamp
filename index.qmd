...
<div style="text-align: center; margin: 30px 0; display: flex; flex-wrap: wrap; justify-content: center; gap: 15px;">
  ...
  <a href="notebooks/ai/module1_introduction_data_centric_ai.ipynb" style="background: linear-gradient(135deg, #a855f7, #7c3aed); color: white; padding: 15px 30px; text-decoration: none; font-size: 16px; border-radius: 10px; font-weight: 600; box-shadow: 0 4px 15px rgba(168, 85, 247, 0.3);">
    🤖 Data Engineering for AI
  </a>
</div>
